...
public class ClassToOrderService {
    ...
    public void fill() {
        ...
        List<ClassToOrder> allOrderBySubclassPriceAsc = classToOrderRepository.findByNameOrderBySubclassPriceAsc(
                "Test");
        List<ClassToOrder> allOrderBySubclassPriceDesc = classToOrderRepository.findByNameOrderBySubclassPriceDesc(
                "Test");
